...
<head>
    ...
    <style>
        ...
        .modal-content {
            background-color: #ffffff; /* Matches dark theme */
            margin: 15% auto;
            padding: 20px;
            border-radius: 8px;
            width: 80%;
        ...
        .modal-content button {
            background: #28a745; /* Red button to match scenario */
            color: #ffffff;
        }
...
<body>
    <div class="container">
        <h1 style="text-align: center">Create a New Course</h1>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.addContent', function() {
                ...
                const contentHtml = `
                    <div class="content">
                        ...
                        <span class="error-message"></span> <!-- Add error message span -->
                    </div>
                `;
            ...
            // Frontend Validation (scoped to course form)
